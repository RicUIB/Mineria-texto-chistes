...
Basandose las ayudas de Enunciado_taller2_chistes_con_metadatos.Rmd" lo anterior generar un modelo de datos con 4 tópicos (de topic models o combinado con catergorías o palabras clave. Asignar cada tópico a su $\alpha$ más alto) y un diiconario de palabras cuaradas por chistes.
...
A partir del paque  word2vec generar una proyección estudiar  si las palbaras (gammas)
